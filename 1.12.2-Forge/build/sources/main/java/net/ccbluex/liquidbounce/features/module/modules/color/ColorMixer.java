...
public class ColorMixer extends Module {
    ...
    public static final ColorElement col2GreenValue = new ColorElement(2, ColorElement.Material.GREEN);    public final IntegerValue blendAmount = new IntegerValue("Mixer-Amount", 2, 2, 10) {
        @Override
    ...
    */
    ...
    public static Color getMixedColor(int index, int seconds) {
        ...
        if (lastColors.length <= 0 || lastFraction.length <= 0)
            regenerateColors(true); // just to make sure it won't go white

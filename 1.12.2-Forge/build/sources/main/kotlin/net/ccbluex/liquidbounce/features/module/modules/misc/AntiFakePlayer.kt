        ...
        when (mode.toLowerCase()) {
            "add" -> {
                when (logStyleValue.get().toLowerCase()) {
                    "arcticNew" -> displayChatMessage("§b$CLIENT_NAME §7» §aAdded§f HYT Bot §7-> §e$name")
                    ...
                    "special" -> displayChatMessage("§8[§d${CLIENT_NAME}§8] §a$name§d被§b青柠§d吃掉啦! §bCiallo(∠・ω< )⌒☆")
                    "wawa1" -> displayChatMessage("§6${CLIENT_NAME} §7=> §fAdded Bot §7$name§f.")
                    "wawa2" -> displayChatMessage("§6${CLIENT_NAME} §7» §f玩家死亡: §7$name")
                    "tomkclient" -> displayChatMessage("§7[§cAntiBots§7] §fAdded a bot(§7$name§f)")
                    ...
                    "verne" -> displayChatMessage("§7[§f${CLIENT_NAME}§7] §fAdd a Bot(§7$name§f)")
                }
            }

            "remove" -> {
                when (logStyleValue.get().toLowerCase()) {
                    "arcticNew" -> displayChatMessage("§b$CLIENT_NAME §7» §cRemoved§f HYT Bot §7-> §e$name")
                    ...
                    "special" -> displayChatMessage("§8[§d${CLIENT_NAME}§8] §a$name§d被§b青柠§d吐出来咯~ §bCiallo(∠・ω< )⌒☆")
                    "wawa1" -> displayChatMessage("§6${CLIENT_NAME} §7=> §fRemoved Bot §7$name§f.")
                    "wawa2" -> displayChatMessage("§6${CLIENT_NAME} §7» §f玩家重生: §7$name")
                    "tomkclient" -> displayChatMessage("§7[§cAntiBots§7] §fRemoved a bot(§7$name§f)")
                    ...
                    "verne" -> displayChatMessage("§7[§f${CLIENT_NAME}§7] §fDel a Bot(§7$name§f)")
                }
            }
        }
    }

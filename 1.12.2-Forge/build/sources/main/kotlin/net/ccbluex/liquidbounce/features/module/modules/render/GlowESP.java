...
public class GlowESP extends Module {
    ...
    public final BoolValue Players = new BoolValue("Players", true);
    ...
    public void setupGlowUniforms(float dir1, float dir2) {
        ...
        glowShader.setUniformf("texelSize", 1.0f / mc.getDisplayWidth(), 1.0f / mc.getDisplayHeight());
    ...
    public void setupOutlineUniforms(float dir1, float dir2) {
        ...
        outlineShader.setUniformf("texelSize", 1.0f / mc.getDisplayWidth(), 1.0f / mc.getDisplayHeight());
...
//            if(entity == mc2.player) return;
            if (!GlowESPHelper.isInView(entity)) continue;

...
public abstract class MixinGuiButton extends Gui {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks) {
        if (this.visible) {
            ...
            if (this.enabled) {
                RenderUtils.drawGradientSideways((float)this.x, (float)(this.y + this.height) - 1.5F, (float)(this.x + this.width), (float)(this.y + this.height), SuperLib.reAlpha(new Color(AColorPalette.r.get(), AColorPalette.g.get(), AColorPalette.b.get()).getRGB(), 0.95F),SuperLib.reAlpha(new Color(AColorPalette.r2.get(), AColorPalette.g2.get(), AColorPalette.b2.get()).getRGB(),0.95F));
            }else {
                RenderUtils.drawGradientSideways((float)this.x, (float)(this.y + this.height) - 1.5F, (float)(this.x + this.width), (float)(this.y + this.height), SuperLib.reAlpha(new Color(AColorPalette.r2.get(), AColorPalette.g2.get(), AColorPalette.b2.get()).getRGB(), 0.95F),SuperLib.reAlpha(new Color(AColorPalette.r.get(), AColorPalette.g.get(), AColorPalette.b.get()).getRGB(),0.95F));
            }

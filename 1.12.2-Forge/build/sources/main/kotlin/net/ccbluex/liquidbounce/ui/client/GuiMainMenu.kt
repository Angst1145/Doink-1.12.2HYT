...
class GuiMainMenu : WrappedGuiScreen() {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        RenderUtils.drawImage(classProvider.createResourceLocation("tomk/bg.png"), 0, 0, sr.scaledWidth, sr.scaledHeight)
        ...
        Fonts.productSans70.drawCenteredStringWithShadow(LiquidBounce.CLIENT_NAME, sr.scaledWidth / 2F, defaultHeight.toFloat() - 30f, -1)

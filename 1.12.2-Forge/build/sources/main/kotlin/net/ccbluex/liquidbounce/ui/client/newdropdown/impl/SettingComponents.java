...
public class SettingComponents extends Component {
    ...
    public void handle(int mouseX, int mouseY, int button, GuiEvents type) {
        ...
        Color color2 = new Color(AColorPalette.RA.get(), AColorPalette.GA.get(), AColorPalette.BA.get());
        Color color1 = new Color(AColorPalette.RA2.get(), AColorPalette.GA2.get(), AColorPalette.BA2.get());

...
import net.ccbluex.liquidbounce.features.module.modules.render.LogoFix
...
import net.ccbluex.liquidbounce.features.module.modules.donk.HytBlink
...
class ModuleManager : Listenable {
    ...
    fun registerModules() {
        ...
        registerModules(
                HytBlink::class.java,
                KillAuraTest::class.java,
                Nolsowgrim::class.java,
                VelocityTest::class.java,

...
class VulcanHopSpeed : SpeedMode("VulcanHopSpeed") {
    ...
    override fun onUpdate() {
        ...
        if ((RotationUtils.targetRotation == null && Math.abs(mc.thePlayer!!.moveStrafing) < 0.1) || (RotationUtils.targetRotation != null && Math.abs(RotationUtils.getAngleDifferencee(MovementUtils.movingYaw, RotationUtils.targetRotation.yaw)) < 45.0f)) {

...
public class ClickGUI extends Module {
    ...
    private final ListValue clickguimodeValue = new ListValue("Mode", new String[] {"LiquidBounce", "Tenacity"}, "Tenacity");
    ...
    public static Color generateColor() {
        return colorRainbow.get() ? ColorUtils.rainbow() : new Color(AColorPalette.RA.get(), AColorPalette.GA.get(), AColorPalette.BA.get());
    }
    public static int generateRGB() {
        return colorRainbow.get() ? ColorUtils.rainbow().getRGB() : new Color(AColorPalette.RA.get(), AColorPalette.GA.get(), AColorPalette.BA.get()).getRGB();
    }
    public static int generateRGB2() {
        return colorRainbow.get() ? ColorUtils.rainbow().getRGB() : new Color(AColorPalette.RA2.get(), AColorPalette.GA2.get(), AColorPalette.BA2.get()).getRGB();
    }
    @Override

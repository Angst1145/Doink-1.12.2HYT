    ...
    override fun drawElement(): Border {
        ...
        if (bV.get()) {
            ...
            BlurBuffer.CustomBlurRoundArea(
                    ...
                    easingwith,
                    easinghealth, radiusValue.get(), BlurStrength.get()
            )
            GL11.glPopMatrix()
            GL11.glTranslated(renderX, renderY, 0.0)
        }
        ...
        for (potionEffect in Objects.requireNonNull(mc.thePlayer)!!.activePotionEffects) {
            ...
            if (Chinese.get()) {
                ...
                val namewith2 =
                    Fonts.posterama30.getStringWidth(name + " " + intToRomanByGreedy(potionEffect.amplifier + 1)).toFloat()
                namewith =
                    Fonts.posterama30.getStringWidth(name + " " + intToRomanByGreedy(potionEffect.amplifier + 1)).toFloat()
                if (namewith2 > namewith3) {
                    namewith3 = namewith2
                ...
                Fonts.posterama30.drawString(potionEffect.getDurationString(), namewith + 32, -(posY - 9.76f), -1)
            }
        ...
        if (Chinese.get()){
            ...
            Fonts.posterama40.drawString("Effects", 17, -3, -1)
        }

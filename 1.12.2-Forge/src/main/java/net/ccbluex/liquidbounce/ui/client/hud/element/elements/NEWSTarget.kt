...
@ElementInfo(name = "Target2")//by Angst
class NEWSTarget : Element(-46.0,-40.0,1F,Side(Side.Horizontal.MIDDLE,Side.Vertical.MIDDLE)) {
    ...
    private fun drawLw(target: IEntityLivingBase, easingHealth: Float) {
        ...
        RenderUtils.drawShadow(1F, 0F, 148F, 50F)
        // draw entity
        // target text

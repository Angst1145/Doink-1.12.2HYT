...
public final class RotationUtils extends MinecraftInstance implements Listenable {
    ...
    public static float getAngleDifferencee(final float a, final float b) {
    ...
    public static double getRotationDifferenceYaw(final IEntity entity) {
        final Rotation rotation = toRotation(getCenter(entity.getEntityBoundingBox()), true);

        return Math.abs(getRotationDifferenceYaw(rotation, new Rotation(mc.getThePlayer().getRotationYaw(), mc.getThePlayer().getRotationPitch())));
    }

    public static double getRotationDifferenceYaw(final Rotation a, final Rotation b) {

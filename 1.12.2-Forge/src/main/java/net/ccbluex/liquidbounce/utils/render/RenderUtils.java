...
public final class RenderUtils extends MinecraftInstance {
    ...
    public static void glColor4(final int hex) {
    ...
    public static void drawCircle(final IEntity entity, final double rad, final int color, final boolean shade) {
        ...
        for (float i = 0; i < Math.PI * 2; i += Math.PI * 2 / 64.F) {
            ...
            c =  RenderUtils.getGradientOffset(
                    new Color(AColorPalette.r.get(), AColorPalette.g.get(), AColorPalette.b.get()),
                    new Color(AColorPalette.r2.get(), AColorPalette.g2.get(), AColorPalette.b2.get()),i
            );
    ...
    public static void drawTexturedRect(float x, float y, float width, float height, String image, IScaledResolution sr) {
        ...
        GlStateManager.enableBlend();
        GlStateManager.disableAlpha();
        mc.getTextureManager().bindTexture((classProvider.createResourceLocation("tomk/shadow/" + image + ".png")));
        GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
    ...
    public static void drawGidentOutlinedRoundedRect(double x, double y, double width, double height, double radius, float linewidth) {
        ...
        //one
        for (int i = 0; i <= 90; i += 3) {
            RenderUtils.setColor(fadeBetween(new Color(AColorPalette.r.get(),AColorPalette.g.get(),AColorPalette.b.get()).getRGB(),new Color(AColorPalette.r2.get(),AColorPalette.g2.get(),AColorPalette.b2.get()).getRGB(),20L * colorI));

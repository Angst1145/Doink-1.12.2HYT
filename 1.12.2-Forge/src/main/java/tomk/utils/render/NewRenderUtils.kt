...
object NewRenderUtils {
    ...
    fun drawTexturedRectWithCustomAlpha(x: Float, y: Float, width: Float, height: Float, image: String, alpha: Float) {
        ...
        Minecraft.getMinecraft().textureManager.bindTexture(ResourceLocation("tomk/shadow/$image.png"))
    ...
    fun drawModalRectWithCustomSizedTexture(
        ...
        val tessellator = MinecraftInstance.classProvider.tessellatorInstance
        val worldrenderer = tessellator.worldRenderer
        worldrenderer.begin(7, MinecraftInstance.classProvider.getVertexFormatEnum(WDefaultVertexFormats.POSITION_TEX))
